// A simple Vercel Function for a Facebook Messenger chatbot.
...
exports.handler = async (event, context) => {
    // IMPORTANT: Retrieve your tokens from Vercel Environment Variables
    const VERIFY_TOKEN = process.env.VERIFY_TOKEN;
    const PAGE_ACCESS_TOKEN = process.env.PAGE_ACCESS_TOKEN;

    if (!VERIFY_TOKEN || !PAGE_ACCESS_TOKEN) {
        console.error('VERIFY_TOKEN or PAGE_ACCESS_TOKEN is not set in Vercel environment variables.');
        return {
            statusCode: 500,
